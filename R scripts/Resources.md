...
4. [Dense NN and use of the RMSProp and Adam optimizers](https://youtu.be/lVIkmxNejVM), This video uses an R workflow as an example to describe how the new ***RMSProp*** and ***Adam*** (V0.1.20) **optimizers** are used to train a deep learning structure.
